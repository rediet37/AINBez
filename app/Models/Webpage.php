...
class Webpage extends Model
{
    ...
    protected $fillable = [
        ...
        'faqs', 'slide1_header', 'slide1_sub', 'slide2_header', 'slide2_sub', 'slide3_header', 'slide3_sub', 'about_page_header', 'about_page_header_desc', 'about_us_title1', 'about_us_desc1', 'about_us_title2',
